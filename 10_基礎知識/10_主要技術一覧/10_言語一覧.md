...
- 概要
  - 主にWebブラウザ上で動作するプログラミング・スクリプト言語
- Superset
...
- Library
  ...
  - [Xamarin](https://dotnet.microsoft.com/ja-jp/apps/xamarin) ※サポート終了
- Package Manager
  - [NuGet](https://www.nuget.org/)
- Build Tool
  - [MSBuild](https://learn.microsoft.com/ja-jp/visualstudio/msbuild/)

### [C++](https://ja.cppreference.com/cpp/language)

- 概要
  - C言語を拡張した高水準のプログラミング言語

### [C](https://ja.cppreference.com/c/language)
